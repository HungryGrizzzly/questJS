...
// Зачем var? лучше не использовать spread, а использовать split
/*
var phrase;
...
// Задача не нуждается в отдельных либах. 
/*
...
// Мог показать хотябы ход решения.

/*
Первое, что тебе нужно сделать - почитать про кодстайл. Их несколько основоных, которые чаще всего используются.
Например гугл или airbnb.
В целом все не так плохо, но нужно подтянуть работу с массивами, какие функции есть и тд. например, анаграмма решается через sort.
Фибоначи можно решить через рекурсию.
*/
